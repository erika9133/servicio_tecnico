...
QT_MOC_LITERAL(1, 8, 15), // "procesarMensaje"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 2), // "go"
QT_MOC_LITERAL(4, 28, 9), // "connected"
QT_MOC_LITERAL(5, 38, 12), // "disconnected"
QT_MOC_LITERAL(6, 51, 13), // "reciveMessage"
QT_MOC_LITERAL(7, 65, 7) // "message"

    },
    "Cliente\0procesarMensaje\0\0go\0connected\0"
    "disconnected\0reciveMessage\0message"
};
...
void Cliente::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->procesarMensaje((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->go(); break;
        case 2: _t->connected(); break;
        case 3: _t->disconnected(); break;
        case 4: _t->reciveMessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cliente::procesarMensaje)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Cliente::procesarMensaje(QString _t1)
{
